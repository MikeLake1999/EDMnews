...
<body data-rsssl="1" class="home page-template page-template-page-15zine-builder page-template-page-15zine-builder-php page page-id-21  cb-sidebar-right  cb-sticky-mm cb-sticky-sb-on  cb-tm-dark cb-body-light cb-menu-light cb-mm-dark cb-footer-dark   cb-m-logo-off cb-m-sticky cb-sw-tm-box cb-sw-header-box cb-sw-menu-box cb-sw-footer-box cb-menu-al-left  cb-fis-b-standard">
    <div class="container">
         ...
         <?php $user1 = $user->GetBanner("contact");
                           while($row = $user1->fetch_array())
                           
                           {
                                   echo '  <div class="cb-contents"><img src='.$row['BannerUrl'].' scale="0"></div>'; 
                           }
                   ?>


         <div class="cb-contents"><h2 style="text-align: center;"><span style="color: #808080;"><strong><em>Contact Us At / Liên Hệ Chúng Tôi Tại</em></strong></span></h2>
<p style="text-align: center;">&nbsp;Please contact our dedicated management team at “<span style="color: #800000;"><em><a href="mailto:info@loopcentral.net">info@loopcentral.net</a></em></span>” for all general inquiries pertaining to <a href="https://loopcentral.net/"><strong>Loop Central</strong></a>.</p>
<p style="text-align: center;">&nbsp;Xin vui lòng liên hệ đại diện của chúng tôi tại “<span style="color: #800000;"><em><a href="mailto:info@loopcentral.net">info@loopcentral.net</a></em></span>” cho bất kỳ câu hỏi gì liên quan đến <a href="https://loopcentral.net/"><strong>Loop Central</strong></a>.</p></div>
